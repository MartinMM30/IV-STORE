...
      return NextResponse.json({ message: "Producto no encontrado" }, { status: 404 });
    }
    return NextResponse.json({ message: "Producto actualizado", product: updatedProduct }, { status: 200 });
  } catch (error) {
...
      return NextResponse.json({ message: "Producto no encontrado" }, { status: 404 });
    }
    return NextResponse.json({ message: "Producto eliminado", product: deleted }, { status: 200 });
  } catch (error) {
